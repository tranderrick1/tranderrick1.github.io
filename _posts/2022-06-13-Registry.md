...
Default admin credentials will get through. After doing some research, v2 is related to the Docker Registry that we saw earlier. Its the api version. We can hit this url and grab the images hosted on there and sift through the blobs for potentially senstitive info.

The endpoints I hit were referenced from these two blogposts:

[https://notsosecure.com/anatomy-of-a-hack-docker-registry](https://notsosecure.com/anatomy-of-a-hack-docker-registry)
